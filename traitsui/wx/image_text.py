...
class ImageText(wx.Window):
    ...
    def __init__(self, parent, theme, text='', border=False):
        ...
        super(ImageText, self).__init__(
            parent, -1, style=wx.FULL_REPAINT_ON_RESIZE)
    ...
    def _get_text_bounds(self):
        ...
        ty = (wdy + slice.xtop + content.top - slice.xtop - slice.xbottom - tdy
              ) // 2
