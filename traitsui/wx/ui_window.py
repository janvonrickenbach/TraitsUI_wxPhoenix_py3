...
class UIWindow ( HasPrivateTraits ):
    ...
    def _set_width ( self, width ):
        self.control.SetSize( wx.Size(width, self.height) )#self.control.SetSize( width, self.height )

    def _get_height ( self ):
        return self.control.GetClientSize().Get()[1]

    def _set_height ( self, height ):
        self.control.SetSize( wx.Size(self.width, height) )#self.control.SetSize( self.width, height )
