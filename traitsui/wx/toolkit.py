...
class GUIToolkit ( Toolkit ):
    ...
    def hook_events ( self, ui, control, events = None, handler = None,
        ...
        for child in control.GetChildren():  #goes through each child of control, and each child of each child
            self.hook_events( ui, child, events, handler, drop_target )  #recursive until child is None
