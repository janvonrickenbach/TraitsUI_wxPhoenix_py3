...
#---------------------------------------------------------------------------
    ...
    def position(self, ui):
        ...
        x = int(min(x, wx.DisplaySize()[0]))
        y = int(min(y, wx.DisplaySize()[1]))
    ...
    def hook_events(self,
        ...
        """
        #app=wx.GetApp() #for debug
        #tlw=app.GetTopWindow() #for debug
        #global kount #debug
        if events is None:
            events = (
                wx.wxEVT_LEFT_DOWN, wx.wxEVT_LEFT_DCLICK, wx.wxEVT_LEFT_UP,
                wx.wxEVT_MIDDLE_DOWN, wx.wxEVT_MIDDLE_DCLICK,
                wx.wxEVT_MIDDLE_UP, wx.wxEVT_RIGHT_DOWN, wx.wxEVT_RIGHT_DCLICK,
                wx.wxEVT_RIGHT_UP, wx.wxEVT_MOTION, wx.wxEVT_ENTER_WINDOW,
                wx.wxEVT_LEAVE_WINDOW, wx.wxEVT_MOUSEWHEEL, wx.wxEVT_PAINT)
            control.SetDropTarget(
                PythonDropTarget(DragHandler(
    ...
    def color_trait(self, *args, **traits):
        from .color_trait import WxColor  # import .color_trait as ct
        return WxColor(*args, **traits)  #ct.WxColor( *args, **traits )
