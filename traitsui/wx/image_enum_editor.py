...
class ReadonlyEditor(Editor):
    ...
    def update_editor(self):
        ...
        """
        self.control.Bitmap(
            bitmap_cache('%s%s%s' % (self.factory.prefix, self.str_value,
                                     self.factory.suffix), False,
    ...
    def _create_image_grid(self, parent):
        ...
        for name in self.factory._names:
            ...
            control = ImageControl(panel,
                                   bitmap_cache('%s%s%s' % (
                                       factory.prefix, name, factory.suffix),
                                                False, factory._image_path),
                                   value == cur_value, self.update_object)
            control.value = value
