...
from traits.api import (Any, Event, HasPrivateTraits, HasStrictTraits,
...
class KeyBindings(HasPrivateTraits):
    ...
    def __init__(self, *bindings, **traits):
        ...
        self.add_trait(
            'bindings', List(
                KeyBinding, minlen=n, maxlen=n, mode='list'))
    ...
    def do(self, event, controllers=[], *args, **kw):
        ...
        return self._do(toolkit().key_event_to_name(event), controllers, args,
