...
class ToolkitEditorFactory(EditorFactory):
    ...
    low_label = Str  #Unicode

    # Label for the high end of the range
    high_label = Str  #Unicode
    ...
    traits_view = View([['low', 'high', '|[Range]'], [
        'low_label{Low}', 'high_label{High}', '|[Range Labels]'
    ], [
        'auto_set{Set automatically}', 'enter_set{Set on enter key pressed}',
        'is_float{Is floating point range}', '-[Options]>'
