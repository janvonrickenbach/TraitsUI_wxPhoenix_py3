...
class Person(Handler):
    ...
    def _annoy_clicked(self, info):
        self.edit_traits(view=View(
            title='Annoying', kind='modal', buttons=['OK']))
...
if __name__ == '__main__':
    ...
    person.configure_traits(view=View(
        fields, kind='livemodal', buttons=LiveButtons))
